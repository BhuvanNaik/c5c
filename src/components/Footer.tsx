      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href="#" className="hover:text-[#289dbc] transition-colors">Home</a>
            <a href="#" className="hover:text-[#289dbc] transition-colors">Features</a>
            ...
            <a href="#" className="hover:text-[#289dbc] transition-colors">Contact</a>
          </div>
        ...
        <div className="border-t border-[#182e4d] pt-8 text-center text-sm text-gray-400">
